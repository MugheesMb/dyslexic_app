...
class FillBlanksS extends StatefulWidget {
  ...
  const FillBlanksS({Key? key}) : super(key: key);

  @override
  State<FillBlanksS> createState() => _FillBlanksSState();
}

class _FillBlanksSState extends State<FillBlanksS> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 56, 60, 114),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksT.routeName);
              }
            },
            child: Icon(
