...
class FillBlanksO extends StatefulWidget {
  static const routeName = "/fill-blanks_O";
  const FillBlanksO({Key? key}) : super(key: key);

  @override
  State<FillBlanksO> createState() => _FillBlanksOState();
}

class _FillBlanksOState extends State<FillBlanksO> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksP.routeName);
              }
            },
            child: Icon(
