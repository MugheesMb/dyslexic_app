...
class FillBlanksK extends StatefulWidget {
  static const routeName = "/fill-blanks_K";
  const FillBlanksK({Key? key}) : super(key: key);

  @override
  State<FillBlanksK> createState() => _FillBlanksKState();
}

class _FillBlanksKState extends State<FillBlanksK> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 41, 44, 83),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksL.routeName);
              }
            },
            child: Icon(
