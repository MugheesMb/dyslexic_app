...
class FillBlanksQ extends StatefulWidget {
  static const routeName = "/fill-blanks_Q";
  const FillBlanksQ({Key? key}) : super(key: key);

  @override
  State<FillBlanksQ> createState() => _FillBlanksQState();
}

class _FillBlanksQState extends State<FillBlanksQ> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
          ...
          children: [
            Row(
              ...
              children: [
                Container(
                    height: 150,
                    width: 150,
                    child: SvgPicture.asset("pic/Q.svg")),
                SizedBox(width: 50),
                Text("=",
                ...
                Container(
                    height: 150,
                    width: 150,
                    child: Image.asset("pic/queen.png"))
              ],
            ),
            SizedBox(height: 20),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Container(
                ...
                width: 70,
                child: Card(
                    color: Color.fromARGB(255, 216, 12, 124),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 240, 166, 6),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksR.routeName);
              }
            },
            child: Icon(
