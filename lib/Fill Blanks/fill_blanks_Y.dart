...
class FillBlanksY extends StatefulWidget {
  static const routeName = "/fill-blanks_Y";
  const FillBlanksY({Key? key}) : super(key: key);

  @override
  State<FillBlanksY> createState() => _FillBlanksYState();
}

class _FillBlanksYState extends State<FillBlanksY> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Container(
                ...
                width: 70,
                child: Card(
                    color: Color.fromARGB(255, 233, 115, 6),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 19, 30, 187),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksZ.routeName);
              }
            },
            child: Icon(
