...
class FillBlanksT extends StatefulWidget {
  static const routeName = "/fill-blanks_T";
  const FillBlanksT({Key? key}) : super(key: key);

  @override
  State<FillBlanksT> createState() => _FillBlanksTState();
}

class _FillBlanksTState extends State<FillBlanksT> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 134, 126, 6),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksU.routeName);
              }
            },
            child: Icon(
