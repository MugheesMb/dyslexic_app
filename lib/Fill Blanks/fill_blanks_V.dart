...
class FillBlanksV extends StatefulWidget {
  static const routeName = "/fill-blanks_V";
  const FillBlanksV({Key? key}) : super(key: key);

  @override
  State<FillBlanksV> createState() => _FillBlanksVState();
}

class _FillBlanksVState extends State<FillBlanksV> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Container(
                ...
                width: 60,
                child: Card(
                    color: Color.fromARGB(255, 98, 4, 248),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 54, 59, 124),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksW.routeName);
              }
            },
            child: Icon(
