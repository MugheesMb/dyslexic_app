...
class FillBlanksP extends StatefulWidget {
  static const routeName = "/fill-blanks_P";
  const FillBlanksP({Key? key}) : super(key: key);

  @override
  State<FillBlanksP> createState() => _FillBlanksPState();
}

class _FillBlanksPState extends State<FillBlanksP> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 16, 163, 53),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksQ.routeName);
              }
            },
            child: Icon(
