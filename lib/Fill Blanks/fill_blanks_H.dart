...
class FillBlanksH extends StatefulWidget {
  static const routeName = "/fill-blanks_H";
  const FillBlanksH({Key? key}) : super(key: key);

  @override
  State<FillBlanksH> createState() => _FillBlanksHState();
}

class _FillBlanksHState extends State<FillBlanksH> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksI.routeName);
              }
            },
            child: Icon(
