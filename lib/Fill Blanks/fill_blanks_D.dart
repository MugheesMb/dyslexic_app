...
class FillBlanksD extends StatefulWidget {
  static const routeName = "/fill-blanks_D";
  const FillBlanksD({Key? key}) : super(key: key);

  @override
  State<FillBlanksD> createState() => _FillBlanksDState();
}

class _FillBlanksDState extends State<FillBlanksD> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Container(
                ...
                width: 70,
                child: Card(
                    color: Color.fromARGB(255, 179, 150, 22),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 73, 112, 9),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksE.routeName);
              }
            },
            child: Icon(
