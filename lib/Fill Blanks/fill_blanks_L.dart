...
class FillBlanksL extends StatefulWidget {
  static const routeName = "/fill-blanks_L";
  const FillBlanksL({Key? key}) : super(key: key);

  @override
  State<FillBlanksL> createState() => _FillBlanksLState();
}

class _FillBlanksLState extends State<FillBlanksL> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
            ...
            Row(
              ...
              children: [
                Container(
                    height: 150,
                    width: 150,
                    child: SvgPicture.asset("pic/L.svg")),
                SizedBox(width: 50),
                Text("=",
                ...
                Container(
                    height: 150,
                    width: 150,
                    child: Image.asset("pic/llama.png"))
              ],
            ),
            SizedBox(height: 20),
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksM.routeName);
              }
            },
            child: Icon(
