...
class FillBlanksN extends StatefulWidget {
  static const routeName = "/fill-blanks_N";
  const FillBlanksN({Key? key}) : super(key: key);

  @override
  State<FillBlanksN> createState() => _FillBlanksNState();
}

class _FillBlanksNState extends State<FillBlanksN> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 15, 114, 59),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksO.routeName);
              }
            },
            child: Icon(
