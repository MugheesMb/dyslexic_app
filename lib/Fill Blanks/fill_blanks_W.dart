...
class FillBlanksW extends StatefulWidget {
  static const routeName = "/fill-blanks_W";
  const FillBlanksW({Key? key}) : super(key: key);

  @override
  State<FillBlanksW> createState() => _FillBlanksWState();
}

class _FillBlanksWState extends State<FillBlanksW> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 12, 122, 45),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksX.routeName);
              }
            },
            child: Icon(
