...
class FillBlanksX extends StatefulWidget {
  static const routeName = "/fill-blanks_X";
  const FillBlanksX({Key? key}) : super(key: key);

  @override
  State<FillBlanksX> createState() => _FillBlanksXState();
}

class _FillBlanksXState extends State<FillBlanksX> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              Container(
                ...
                width: 70,
                child: Card(
                    color: Color.fromARGB(255, 4, 130, 248),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 11, 93, 99),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksY.routeName);
              }
            },
            child: Icon(
