...
class FillBlanksJ extends StatefulWidget {
  static const routeName = "/fill-blanks_J";
  const FillBlanksJ({Key? key}) : super(key: key);

  @override
  State<FillBlanksJ> createState() => _FillBlanksJState();
}

class _FillBlanksJState extends State<FillBlanksJ> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Container(
                ...
                width: 60,
                child: Card(
                    color: Color.fromARGB(255, 121, 11, 71),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 88, 95, 192),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksK.routeName);
              }
            },
            child: Icon(
