...
class FillBlanksM extends StatefulWidget {
  static const routeName = "/fill-blanks_M";
  const FillBlanksM({Key? key}) : super(key: key);

  @override
  State<FillBlanksM> createState() => _FillBlanksMState();
}

class _FillBlanksMState extends State<FillBlanksM> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
          ...
          children: [
            Row(
              ...
              children: [
                Container(
                    height: 150,
                    width: 150,
                    child: SvgPicture.asset("pic/M.svg")),
                SizedBox(width: 50),
                Text("=",
                ...
                Container(
                    height: 150,
                    width: 150,
                    child: Image.asset("pic/money.png"))
              ],
            ),
            SizedBox(height: 20),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Container(
                ...
                width: 70,
                child: Card(
                    color: Color.fromARGB(255, 85, 25, 58),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 62, 70, 179),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksN.routeName);
              }
            },
            child: Icon(
