...
class FillBlanksE extends StatefulWidget {
  static const routeName = "/fill-blanks_E";
  const FillBlanksE({Key? key}) : super(key: key);

  @override
  State<FillBlanksE> createState() => _FillBlanksEState();
}

class _FillBlanksEState extends State<FillBlanksE> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
      ...
      body: Stack(children: [
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Container(
                ...
                width: 50,
                child: Card(
                    color: Color.fromARGB(255, 18, 167, 68),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          width: 50.0,
          //height: 70.0,
          top: selected ? 400.0 : 527.0,
          left: selected ? 256 : 136,
          //right: 290
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 24, 32, 146),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksF.routeName);
              }
            },
            child: Icon(
