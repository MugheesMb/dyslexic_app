...
class FillBlanksI extends StatefulWidget {
  static const routeName = "/fill-blanks_I";
  const FillBlanksI({Key? key}) : super(key: key);

  @override
  State<FillBlanksI> createState() => _FillBlanksIState();
}

class _FillBlanksIState extends State<FillBlanksI> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksJ.routeName);
              }
            },
            child: Icon(
