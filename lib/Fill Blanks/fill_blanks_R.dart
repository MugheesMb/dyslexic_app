...
class FillBlanksR extends StatefulWidget {
  static const routeName = "/fill-blanks_R";
  const FillBlanksR({Key? key}) : super(key: key);

  @override
  State<FillBlanksR> createState() => _FillBlanksRState();
}

class _FillBlanksRState extends State<FillBlanksR> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 127, 8, 151),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksS.routeName);
              }
            },
            child: Icon(
