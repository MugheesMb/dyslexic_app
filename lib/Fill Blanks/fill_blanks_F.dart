...
class FillBlanksF extends StatefulWidget {
  static const routeName = "/fill-blanks_F";
  const FillBlanksF({Key? key}) : super(key: key);

  @override
  State<FillBlanksF> createState() => _FillBlanksFState();
}

class _FillBlanksFState extends State<FillBlanksF> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              Container(
                ...
                width: 70,
                child: Card(
                    color: Color.fromARGB(255, 107, 8, 63),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 28, 153, 175),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksG.routeName);
              }
            },
            child: Icon(
