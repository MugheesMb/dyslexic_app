...
class FillBlanksG extends StatefulWidget {
  static const routeName = "/fill-blanks_G";
  const FillBlanksG({Key? key}) : super(key: key);

  @override
  State<FillBlanksG> createState() => _FillBlanksGState();
}

class _FillBlanksGState extends State<FillBlanksG> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
      ...
      body: Stack(children: [
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              Container(
                ...
                width: 70,
                child: Card(
                    color: Color.fromARGB(255, 180, 80, 135),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
        ...
        AnimatedPositioned(
          width: 70.0,
          //height: 70.0,
          top: selected ? 387.0 : 527.0,
          left: selected ? 171 : 256,
          //right: 290
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              child: Card(
                  color: Color.fromARGB(255, 87, 96, 218),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksH.routeName);
              }
            },
            child: Icon(
