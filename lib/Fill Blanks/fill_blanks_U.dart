...
class FillBlanksU extends StatefulWidget {
  static const routeName = "/fill-blanks_U";
  const FillBlanksU({Key? key}) : super(key: key);

  @override
  State<FillBlanksU> createState() => _FillBlanksUState();
}

class _FillBlanksUState extends State<FillBlanksU> {
  List image = [
    "pic/apple.png",
    "pic/ball.png",
    "pic/carrot.png",
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                Navigator.of(context).pushNamed(FillBlanksV.routeName);
              }
            },
            child: Icon(
