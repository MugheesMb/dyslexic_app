...
import 'addition_9_7to11.dart';

class Addition7To11_8 extends StatefulWidget {
  static const routeName = "add-7to11-8";
  const Addition7To11_8({Key? key}) : super(key: key);

  @override
  State<Addition7To11_8> createState() => _Addition7To11_8State();
}

class _Addition7To11_8State extends State<Addition7To11_8> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Addition7To11_9()));
              }
            },
            child: Icon(
