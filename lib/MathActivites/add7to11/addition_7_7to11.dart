...
import 'package:dyslexiaa/MathActivites/add7to11/addition_8_7to11.dart';
...
class Addition7To11_7 extends StatefulWidget {
  static const routeName = "add-7to11-7";
  const Addition7To11_7({Key? key}) : super(key: key);

  @override
  State<Addition7To11_7> createState() => _Addition7To11_7State();
}

class _Addition7To11_7State extends State<Addition7To11_7> {
  int no1 = 48;
  bool selected = false;
              ...
              setState(() {
                if (selected == true) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Addition7To11_8()));
                }
