...
import 'package:dyslexiaa/MathActivites/add4to6/addition_8_4to6.dart';
...
import 'addition_6_7to11.dart';

class Addition7To11_5 extends StatefulWidget {
  static const routeName = "add-7to11-5";
  const Addition7To11_5({Key? key}) : super(key: key);

  @override
  State<Addition7To11_5> createState() => _Addition7To11_5State();
}

class _Addition7To11_5State extends State<Addition7To11_5> {
  late int no1;
  bool selected = false;
              ...
              setState(() {
                if (selected == true) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Addition7To11_6()));
                }
              });
            },
            child: Icon(
