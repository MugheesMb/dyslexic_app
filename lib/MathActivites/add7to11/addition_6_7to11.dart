...
import 'addition_7_7to11.dart';

class Addition7To11_6 extends StatefulWidget {
  static const routeName = "add-7to11-6";
  const Addition7To11_6({Key? key}) : super(key: key);

  @override
  State<Addition7To11_6> createState() => _Addition7To11_6State();
}

class _Addition7To11_6State extends State<Addition7To11_6> {
  late int no1;
  bool selected = false;
              ...
              setState(() {
                if (selected == true) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Addition7To11_7()));
                }
              });
            },
            child: Icon(
