...
import 'addition_10_7to11.dart';

class Addition7To11_9 extends StatefulWidget {
  static const routeName = "add-7to11-9";
  const Addition7To11_9({Key? key}) : super(key: key);

  @override
  State<Addition7To11_9> createState() => _Addition7To11_9State();
}

class _Addition7To11_9State extends State<Addition7To11_9> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Addition7To11_10()));
              }
            },
            child: Icon(
