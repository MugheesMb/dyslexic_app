...
import 'package:dyslexiaa/MathActivites/add4to6/addition_3_4to6.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_svg/flutter_svg.dart';
import '../../Widgets/option_box.dart';
import '/MathActivites/math_activity_screen.dart';
import 'addition_2_7to11.dart';

class Addition7To11_1 extends StatefulWidget {
  static const routeName = "add-7to11-1";
  const Addition7To11_1({Key? key}) : super(key: key);

  @override
  State<Addition7To11_1> createState() => _Addition7To11_1State();
}

class _Addition7To11_1State extends State<Addition7To11_1> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Addition7To11_2()));
              }
            },
            child: Icon(
