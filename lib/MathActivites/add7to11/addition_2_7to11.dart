...
import 'addition_3_7to11.dart';

class Addition7To11_2 extends StatefulWidget {
  static const routeName = "add-7to11-2";
  const Addition7To11_2({Key? key}) : super(key: key);

  @override
  State<Addition7To11_2> createState() => _Addition7To11_2State();
}

class _Addition7To11_2State extends State<Addition7To11_2> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Addition7To11_3()));
              }
            },
            child: Icon(
