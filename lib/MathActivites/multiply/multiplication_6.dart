...
class Multiply6 extends StatefulWidget {
  static const routeName = "/multiplication-6";
  const Multiply6({Key? key}) : super(key: key);

  @override
  State<Multiply6> createState() => _Multiply6State();
}

class _Multiply6State extends State<Multiply6> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Multiply7()));
              }
            },
            child: Icon(
