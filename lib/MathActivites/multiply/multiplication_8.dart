...
class Multiply8 extends StatefulWidget {
  static const routeName = "/multiplication-8";
  const Multiply8({Key? key}) : super(key: key);

  @override
  State<Multiply8> createState() => _Multiply8State();
}

class _Multiply8State extends State<Multiply8> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Multiply9()));
              }
            },
            child: Icon(
