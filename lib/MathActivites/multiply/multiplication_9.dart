...
import 'package:dyslexiaa/MathActivites/multiply/multiplication_10.dart';
...
class Multiply9 extends StatefulWidget {
  static const routeName = "/multiplication-9";
  const Multiply9({Key? key}) : super(key: key);

  @override
  State<Multiply9> createState() => _Multiply9State();
}

class _Multiply9State extends State<Multiply9> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Multiply10()));
              }
            },
            child: Icon(
