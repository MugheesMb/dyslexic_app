...
import 'package:dyslexiaa/MathActivites/multiply/multiplication_8.dart';
...
class Multiply7 extends StatefulWidget {
  static const routeName = "/multiplication-7";
  const Multiply7({Key? key}) : super(key: key);

  @override
  State<Multiply7> createState() => _Multiply7State();
}

class _Multiply7State extends State<Multiply7> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Multiply8()));
              }
            },
            child: Icon(
