...
class Multiply5 extends StatefulWidget {
  static const routeName = "/multiplication-5";
  const Multiply5({Key? key}) : super(key: key);

  @override
  State<Multiply5> createState() => _Multiply5State();
}

class _Multiply5State extends State<Multiply5> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Multiply6()));
              }
            },
            child: Icon(
