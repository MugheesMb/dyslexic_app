...
class Multiply3 extends StatefulWidget {
  static const routeName = "/multiplication-3";
  const Multiply3({Key? key}) : super(key: key);

  @override
  State<Multiply3> createState() => _Multiply3State();
}

class _Multiply3State extends State<Multiply3> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Multiply4()));
              }
            },
            child: Icon(
