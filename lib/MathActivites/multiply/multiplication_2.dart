...
import 'package:dyslexiaa/MathActivites/multiply/multiplication_3.dart';
...
class Multiply2 extends StatefulWidget {
  static const routeName = "/multiplication-2";
  const Multiply2({Key? key}) : super(key: key);

  @override
  State<Multiply2> createState() => _Multiply2State();
}

class _Multiply2State extends State<Multiply2> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Multiply3()));
              }
            },
            child: Icon(
