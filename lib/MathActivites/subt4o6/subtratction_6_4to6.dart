...
import 'package:dyslexiaa/MathActivites/subt4o6/subtratction_7_4to6.dart';
...
class Subtraction4to6_6 extends StatefulWidget {
  static const routeName = "sub-7to11-6";
  const Subtraction4to6_6({Key? key}) : super(key: key);

  @override
  State<Subtraction4to6_6> createState() => _Subtraction4to6_6State();
}

class _Subtraction4to6_6State extends State<Subtraction4to6_6> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction4to6_7()));
              }
            },
            child: Icon(
