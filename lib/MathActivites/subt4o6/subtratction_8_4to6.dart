...
import 'package:dyslexiaa/MathActivites/subt4o6/subtratction_9_4to6.dart';
...
class Subtraction4to6_8 extends StatefulWidget {
  static const routeName = "sub-7to11-8";
  const Subtraction4to6_8({Key? key}) : super(key: key);

  @override
  State<Subtraction4to6_8> createState() => _Subtraction4to6_8State();
}

class _Subtraction4to6_8State extends State<Subtraction4to6_8> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction4to6_9()));
              }
            },
            child: Icon(
