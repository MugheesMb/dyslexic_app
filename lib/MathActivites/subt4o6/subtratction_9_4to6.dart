...
class Subtraction4to6_9 extends StatefulWidget {
  static const routeName = "sub-7to11-9";
  const Subtraction4to6_9({Key? key}) : super(key: key);

  @override
  State<Subtraction4to6_9> createState() => _Subtraction4to6_9State();
}

class _Subtraction4to6_9State extends State<Subtraction4to6_9> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction4to6_10()));
              }
            },
            child: Icon(
