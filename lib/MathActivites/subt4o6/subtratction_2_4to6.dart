// ignore_for_file: camel_case_types, prefer_const_constructors, sized_box_for_whitespace, unused_import, prefer_const_literals_to_create_immutables

import 'dart:math';

import 'package:dyslexiaa/MathActivites/subt4o6/subtratction_3_4to6.dart';
...
class Subtraction4to6_2 extends StatefulWidget {
  const Subtraction4to6_2({Key? key}) : super(key: key);

  @override
  State<Subtraction4to6_2> createState() => _Subtraction4to6_2State();
}

class _Subtraction4to6_2State extends State<Subtraction4to6_2> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction4To6_3()));
              }
            },
            child: Icon(
