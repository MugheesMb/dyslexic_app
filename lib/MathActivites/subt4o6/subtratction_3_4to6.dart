...
import 'package:dyslexiaa/MathActivites/subt4o6/subtratction_4_4to6.dart';
...
class Subtraction4To6_3 extends StatefulWidget {
  static const routeName = "sub-4to6-3";
  const Subtraction4To6_3({Key? key}) : super(key: key);

  @override
  State<Subtraction4To6_3> createState() => _Subtraction4To6_3State();
}

class _Subtraction4To6_3State extends State<Subtraction4To6_3> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction4to6_4()));
              }
            },
            child: Icon(
