...
import 'package:dyslexiaa/MathActivites/subt4o6/subtratction_8_4to6.dart';
...
class Subtraction4to6_7 extends StatefulWidget {
  const Subtraction4to6_7({Key? key}) : super(key: key);

  @override
  State<Subtraction4to6_7> createState() => _Subtraction4to6_7State();
}

class _Subtraction4to6_7State extends State<Subtraction4to6_7> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction4to6_8()));
              }
            },
            child: Icon(
