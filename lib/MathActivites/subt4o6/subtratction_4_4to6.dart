...
import 'package:dyslexiaa/MathActivites/subt4o6/subtratction_5_4to6.dart';
...
class Subtraction4to6_4 extends StatefulWidget {
  static const routeName = "sub-4to6-4";
  const Subtraction4to6_4({Key? key}) : super(key: key);

  @override
  State<Subtraction4to6_4> createState() => _Subtraction4to6_4State();
}

class _Subtraction4to6_4State extends State<Subtraction4to6_4> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction4to6_5()));
              }
            },
            child: Icon(
