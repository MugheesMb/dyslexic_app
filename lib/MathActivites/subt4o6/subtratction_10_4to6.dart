...
class Subtraction4to6_10 extends StatefulWidget {
  ...
  const Subtraction4to6_10({Key? key}) : super(key: key);

  @override
  State<Subtraction4to6_10> createState() => _Subtraction4to6_10State();
}

class _Subtraction4to6_10State extends State<Subtraction4to6_10> {
  double subtraction4_6 = 0.08;
  late int no1;
  bool selected = false;
