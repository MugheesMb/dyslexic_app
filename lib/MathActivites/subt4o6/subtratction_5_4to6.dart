// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_const_constructors, sized_box_for_whitespace, unnecessary_new, avoid_print, camel_case_types, unused_import

import 'package:dyslexiaa/MathActivites/math_activity_screen.dart';
import 'package:dyslexiaa/MathActivites/subt4o6/subtratction_6_4to6.dart';
...
class Subtraction4to6_5 extends StatefulWidget {
  static const routeName = "sub-7to11-5";
  const Subtraction4to6_5({Key? key}) : super(key: key);

  @override
  State<Subtraction4to6_5> createState() => _Subtraction4to6_5State();
}

class _Subtraction4to6_5State extends State<Subtraction4to6_5> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction4to6_6()));
              }
            },
            child: Icon(
