...
import 'package:dyslexiaa/MathActivites/multiply/multiplication_4.dart';
...
import 'division_4.dart';

class Divide3 extends StatefulWidget {
  static const routeName = "/multiplication-3";
  const Divide3({Key? key}) : super(key: key);

  @override
  State<Divide3> createState() => _Divide3State();
}

class _Divide3State extends State<Divide3> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Divide4()));
              }
            },
            child: Icon(
