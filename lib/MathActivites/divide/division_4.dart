...
import 'division_5.dart';

class Divide4 extends StatefulWidget {
  static const routeName = "/division-4";
  const Divide4({Key? key}) : super(key: key);

  @override
  State<Divide4> createState() => _Divide4State();
}

class _Divide4State extends State<Divide4> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Divide5()));
              }
            },
            child: Icon(
