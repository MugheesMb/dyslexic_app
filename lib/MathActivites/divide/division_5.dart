...
import 'package:dyslexiaa/MathActivites/multiply/multiplication_6.dart';
...
import 'division_6.dart';

class Divide5 extends StatefulWidget {
  static const routeName = "/division-5";
  const Divide5({Key? key}) : super(key: key);

  @override
  State<Divide5> createState() => _Divide5State();
}

class _Divide5State extends State<Divide5> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Divide6()));
              }
            },
            child: Icon(
