...
import 'division_2.dart';

class Divide1 extends StatefulWidget {
  static const routeName = "/divide-1";
  const Divide1({Key? key}) : super(key: key);

  @override
  State<Divide1> createState() => _Divide1State();
}

class _Divide1State extends State<Divide1> {
  int no1 = 2;
  bool selected = false;
              ...
              setState(() {
                if (selected == true) {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Divide2()));
                }
