...
import 'package:dyslexiaa/MathActivites/multiply/multiplication_9.dart';
...
import 'division_9.dart';

class Divide8 extends StatefulWidget {
  static const routeName = "/division-8";
  const Divide8({Key? key}) : super(key: key);

  @override
  State<Divide8> createState() => _Divide8State();
}

class _Divide8State extends State<Divide8> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Divide9()));
              }
            },
            child: Icon(
