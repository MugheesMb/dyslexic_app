...
import 'division_8.dart';

class Divide7 extends StatefulWidget {
  static const routeName = "/division-7";
  const Divide7({Key? key}) : super(key: key);

  @override
  State<Divide7> createState() => _Divide7State();
}

class _Divide7State extends State<Divide7> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Divide8()));
              }
            },
            child: Icon(
