...
class Divide10 extends StatefulWidget {
  static const routeName = "/division-10";
  const Divide10({Key? key}) : super(key: key);

  @override
  State<Divide10> createState() => _Divide10State();
}

class _Divide10State extends State<Divide10> {
  double division4_6 = 0.08;
  late int no1;
  bool selected = false;
        ...
        child: FloatingActionButton(
            onPressed: () {
              if (selected == true) {
                ...
                setState(() {
                  Progress.setdivision4_6(division4_6);
                  Progress.TotalProgress();
                    progRef.doc(user!.id).collection('ActivityDetail').doc('Division').set({
      "Completed": true,
    });
                });
              }
