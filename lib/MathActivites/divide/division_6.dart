...
import 'package:dyslexiaa/MathActivites/multiply/multiplication_7.dart';
...
import 'division_7.dart';

class Divide6 extends StatefulWidget {
  static const routeName = "/division-6";
  const Divide6({Key? key}) : super(key: key);

  @override
  State<Divide6> createState() => _Divide6State();
}

class _Divide6State extends State<Divide6> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Divide7()));
              }
            },
            child: Icon(
