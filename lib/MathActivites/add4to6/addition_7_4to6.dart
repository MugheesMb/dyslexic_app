...
class Addition4To6_7 extends StatefulWidget {
  ...
  const Addition4To6_7({Key? key}) : super(key: key);

  @override
  State<Addition4To6_7> createState() => _Addition4To6_7State();
}

class _Addition4To6_7State extends State<Addition4To6_7> {
  late int no1;
  bool selected = false;
              ...
              setState(() {
                if (selected == true) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Addition4To6_8()));
                }
              });
            },
            child: Icon(
