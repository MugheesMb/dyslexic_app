...
import 'package:dyslexiaa/MathActivites/add4to6/addition_7_4to6.dart';
...
class Addition4To6_6 extends StatefulWidget {
  ...
  const Addition4To6_6({Key? key}) : super(key: key);

  @override
  _Addition4To6_6State createState() => _Addition4To6_6State();
}

class _Addition4To6_6State extends State<Addition4To6_6> {
  bool selected = false;
  int no1 = 11;
              ...
              setState(() {
                if (selected == true) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Addition4To6_7()));
                }
              });
            },
            child: Icon(
