...
import 'package:dyslexiaa/MathActivites/add4to6/addition_10_4to6.dart';
...
class Addition4To6_9 extends StatefulWidget {
  static const routeName = "add-4to6-9";
  const Addition4To6_9({Key? key}) : super(key: key);

  @override
  State<Addition4To6_9> createState() => _Addition4To6_9State();
}

class _Addition4To6_9State extends State<Addition4To6_9> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Addition4To6_10()));
              }
            },
            child: Icon(
