...
import 'package:dyslexiaa/MathActivites/add4to6/addition_4_4to6.dart';
...
class Addition4To6_3 extends StatefulWidget {
  static const routeName = "add-4to6-3";
  const Addition4To6_3({Key? key}) : super(key: key);

  @override
  State<Addition4To6_3> createState() => _Addition4To6_3State();
}

class _Addition4To6_3State extends State<Addition4To6_3> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Addition4To6_4()));
              }
            },
            child: Icon(
