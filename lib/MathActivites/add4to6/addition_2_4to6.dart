...
class Addition4To6_2 extends StatefulWidget {
  static const routeName = "add-4to6-2";
  const Addition4To6_2({Key? key}) : super(key: key);

  @override
  State<Addition4To6_2> createState() => _Addition4To6_2State();
}

class _Addition4To6_2State extends State<Addition4To6_2> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Addition4To6_3()));
              }
            },
            child: Icon(
