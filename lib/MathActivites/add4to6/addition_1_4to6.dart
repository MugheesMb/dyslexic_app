// ignore_for_file: prefer_const_constructors, sized_box_for_whitespace, unused_local_variable, camel_case_types, prefer_const_literals_to_create_immutables
...
class Addition4To6_1 extends StatefulWidget {
  static const routeName = "/addition-4to6";
  const Addition4To6_1({Key? key}) : super(key: key);

  @override
  _Addition4To6_1State createState() => _Addition4To6_1State();
}

class _Addition4To6_1State extends State<Addition4To6_1> {
  bool selected = false;
  int no1 = 2;
              ...
              setState(() {
                if (selected == true) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Addition4To6_2()));
                }
              });
            },
            child: Icon(
