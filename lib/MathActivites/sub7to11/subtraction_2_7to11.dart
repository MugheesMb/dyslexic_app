...
import 'package:dyslexiaa/MathActivites/sub7to11/subtraction_3_7to11.dart';
...
class Subtraction7to11_2 extends StatefulWidget {
  const Subtraction7to11_2({Key? key}) : super(key: key);

  @override
  State<Subtraction7to11_2> createState() => _Subtraction7to11_2State();
}

class _Subtraction7to11_2State extends State<Subtraction7to11_2> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction7To11_3()));
              }
            },
            child: Icon(
