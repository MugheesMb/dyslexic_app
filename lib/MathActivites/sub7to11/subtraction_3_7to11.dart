...
import 'package:dyslexiaa/MathActivites/sub7to11/subtraction_4_7to11.dart';
...
class Subtraction7To11_3 extends StatefulWidget {
  static const routeName = "sub-7to11-3";
  const Subtraction7To11_3({Key? key}) : super(key: key);

  @override
  State<Subtraction7To11_3> createState() => _Subtraction7To11_3State();
}

class _Subtraction7To11_3State extends State<Subtraction7To11_3> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction7To11_4()));
              }
            },
            child: Icon(
