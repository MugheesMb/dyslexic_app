...
import 'package:dyslexiaa/MathActivites/sub7to11/subtraction_6_7to11.dart';
...
class Subtraction7To11_5 extends StatefulWidget {
  static const routeName = "sub-7to11-5";
  const Subtraction7To11_5({Key? key}) : super(key: key);

  @override
  State<Subtraction7To11_5> createState() => _Subtraction7To11_5State();
}

class _Subtraction7To11_5State extends State<Subtraction7To11_5> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction7To11_6()));
              }
            },
            child: Icon(
