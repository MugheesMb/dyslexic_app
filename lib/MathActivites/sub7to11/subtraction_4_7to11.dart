...
import 'package:dyslexiaa/MathActivites/sub7to11/subtraction_5_7to11.dart';
...
class Subtraction7To11_4 extends StatefulWidget {
  static const routeName = "sub-7to11-4";
  const Subtraction7To11_4({Key? key}) : super(key: key);

  @override
  State<Subtraction7To11_4> createState() => _Subtraction7To11_4State();
}

class _Subtraction7To11_4State extends State<Subtraction7To11_4> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction7To11_5()));
              }
            },
            child: Icon(
