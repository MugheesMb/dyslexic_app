...
import 'package:dyslexiaa/MathActivites/sub7to11/subtraction_8_7to11.dart';
...
class Subtraction7to11_7 extends StatefulWidget {
  const Subtraction7to11_7({Key? key}) : super(key: key);

  @override
  State<Subtraction7to11_7> createState() => _Subtraction7to11_7State();
}

class _Subtraction7to11_7State extends State<Subtraction7to11_7> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction7To11_8()));
              }
            },
            child: Icon(
