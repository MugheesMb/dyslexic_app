...
class Subtraction7To11_9 extends StatefulWidget {
  static const routeName = "sub-7to11-9";
  const Subtraction7To11_9({Key? key}) : super(key: key);

  @override
  State<Subtraction7To11_9> createState() => _Subtraction7To11_9State();
}

class _Subtraction7To11_9State extends State<Subtraction7To11_9> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction7To11_10()));
              }
            },
            child: Icon(
