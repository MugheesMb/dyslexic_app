...
import 'package:dyslexiaa/MathActivites/sub7to11/subtraction_2_7to11.dart';
...
class Subtraction7To11_1 extends StatefulWidget {
  static const routeName = "sub-7to11-1";
  const Subtraction7To11_1({Key? key}) : super(key: key);

  @override
  State<Subtraction7To11_1> createState() => _Subtraction7To11_1State();
}

class _Subtraction7To11_1State extends State<Subtraction7To11_1> {
  late int no1;
  bool selected = false;
            ...
            onPressed: () {
              if (selected == true) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Subtraction7to11_2()));
              }
            },
            child: Icon(
